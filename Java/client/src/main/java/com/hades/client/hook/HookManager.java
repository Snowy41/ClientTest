...
public class HookManager {
        ...
        private static void registerHooks() {
                ...
                try {
                        ...
                        // JSR/RET!
                        // Find the LaunchClassLoader from any thread — it may not be our current
                        // thread's CL
                        ...
                        if (launchCL != null) {
                                ...
                                try {
                                        java.lang.reflect.Method addExclusion = launchCL.getClass().getMethod(
                                ...
                                try {
                                        ...
                                        if (hadesJarUrl != null) {
                                                // Use LaunchClassLoader's own public addURL, NOT URLClassLoader's
                                                // protected one
                                                java.lang.reflect.Method addURL = launchCL.getClass()
                                                                .getMethod("addURL", java.net.URL.class);
                        ...
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        ...
                                        .with(new net.bytebuddy.agent.builder.AgentBuilder.Listener.Adapter() {
                                                ...
                                                public void onError(String typeName, ClassLoader classLoader,
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                Throwable throwable) {
                                                        LOG.error("ByteBuddy error instrumenting " + typeName + ": "
                                                        ...
                                                        protectionDomain) -> builder
                                                                        .visit(
                                                                                        net.bytebuddy.asm.Advice.to(
                                                                                                        com.hades.client.hook.hooks.RunTickHook.class)
                                                                                                        .on(net.bytebuddy.matcher.ElementMatchers
                                                                                                                        .named("s")))
                                                                        .visit(
                                                                                        net.bytebuddy.asm.Advice.to(
                                                                                                        com.hades.client.hook.hooks.ClickMouseHook.class)
                                                                                                        .on(net.bytebuddy.matcher.ElementMatchers
                                                                                                                        .named("aw"))))
                        ...
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        ...
                                        .with(new net.bytebuddy.agent.builder.AgentBuilder.Listener.Adapter() {
                                                ...
                                                public void onTransformation(
                                                                ...
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                net.bytebuddy.dynamic.DynamicType dynamicType) {
                                                        LOG.info("ByteBuddy transformed (EntityPlayerSP): "
                                                                        + typeDescription.getName());
                                                }
                                                ...
                                                public void onError(String typeName, ClassLoader classLoader,
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                Throwable throwable) {
                                                        LOG.error("ByteBuddy error (EntityPlayerSP) " + typeName + ": "
                                                                        + throwable.getMessage());
                                                }
                                        })
                                                                                        ...
                                                                                        net.bytebuddy.asm.Advice.to(
                                                                                                        ...
                                                                                                        .on(
                                                                                                                        (net.bytebuddy.matcher.ElementMatchers
                                                                                                                                        .named("p")
                                                                                                                                        .or(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .named("onUpdateWalkingPlayer")))
                                                                                                                                        .and(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .takesNoArguments()))))
                                        .installOn(instrumentation);

                        // ── Hook MovementInputFromOptions.updatePlayerMoveState (bev.a) ──
                        // Intercepts WASD key tracking immediately after Vanilla polls the Keyboard but
                        // before any
                        // Physics calculations. This is crucial for Silent Movement because if forward
                        // is zero mathematically, player
                        ...
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        ...
                                        .with(new net.bytebuddy.agent.builder.AgentBuilder.Listener.Adapter() {
                                                ...
                                                public void onTransformation(
                                                                ...
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                net.bytebuddy.dynamic.DynamicType dynamicType) {
                                                        LOG.info("ByteBuddy transformed (MovementInput): "
                                                                        + typeDescription.getName());
                                                }
                                                ...
                                                public void onError(String typeName, ClassLoader classLoader,
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                Throwable throwable) {
                                                        LOG.error("ByteBuddy error (MovementInput) " + typeName + ": "
                                                                        + throwable.getMessage());
                                                }
                                        })
                                        .type(net.bytebuddy.matcher.ElementMatchers.namedOneOf(
                                                        "net.minecraft.util.MovementInputFromOptions", "bev"))
                                        .transform((builder, typeDescription, classLoader, module,
                                                        protectionDomain) -> builder
                                                                        .visit(
                                                                                        net.bytebuddy.asm.Advice.to(
                                                                                                        ...
                                                                                                        .on(
                                                                                                                        (net.bytebuddy.matcher.ElementMatchers
                                                                                                                                        .named("a")
                                                                                                                                        .or(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .named("updatePlayerMoveState")))
                                                                                                                                        .and(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .takesNoArguments()))))
                                        .installOn(instrumentation);

                        // ── Hook Entity.moveEntity (pk.d) ──
                        // Fires MoveEvent which allows altering X/Y/Z motion without setting velocity
                        // directly.
                        ...
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        ...
                                        .with(new net.bytebuddy.agent.builder.AgentBuilder.Listener.Adapter() {
                                                ...
                                                public void onTransformation(
                                                                ...
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                net.bytebuddy.dynamic.DynamicType dynamicType) {
                                                        LOG.info("ByteBuddy transformed (Entity): "
                                                                        + typeDescription.getName());
                                                }
                                                ...
                                                public void onError(String typeName, ClassLoader classLoader,
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                Throwable throwable) {
                                                        LOG.error("ByteBuddy error (Entity) " + typeName + ": "
                                                                        + throwable.getMessage());
                                                }
                                        })
                        ...
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        ...
                                        .with(new net.bytebuddy.agent.builder.AgentBuilder.Listener.Adapter() {
                                                ...
                                                public void onTransformation(
                                                                ...
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                net.bytebuddy.dynamic.DynamicType dynamicType) {
                                                        LOG.info("ByteBuddy transformed (EntityLivingBase): "
                                                                        + typeDescription.getName());
                                                }
                                                ...
                                                public void onError(String typeName, ClassLoader classLoader,
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                Throwable throwable) {
                                                        LOG.error("ByteBuddy error (EntityLivingBase) " + typeName
                                                                        + ": " + throwable.getMessage());
                                                }
                                        })
                                                                                        ...
                                                                                        net.bytebuddy.asm.Advice.to(
                                                                                                        ...
                                                                                                        .on(
                                                                                                                        (net.bytebuddy.matcher.ElementMatchers
                                                                                                                                        .named("g")
                                                                                                                                        .or(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .named("moveEntityWithHeading")))
                                                                                                                                        .and(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .takesArguments(float.class,
                                                                                                                                                                        float.class))))
                                                                        .visit(
                                                                                        net.bytebuddy.asm.Advice.to(
                                                                                                        ...
                                                                                                        .on(
                                                                                                                        (net.bytebuddy.matcher.ElementMatchers
                                                                                                                                        ...
                                                                                                                                        .or(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .named("setSprinting")))
                                                                                                                                        .and(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .takesArguments(boolean.class)))))
                                        .installOn(instrumentation);

                        // ── Hook Entity.applyEntityCollision (pk.i/func_70108_f) ──
                        // Prevents Vanilla's local client-side 0.05 knockback accumulation when inside
                        // entities.
                        ...
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        ...
                                        .with(new net.bytebuddy.agent.builder.AgentBuilder.Listener.Adapter() {
                                                ...
                                                public void onTransformation(
                                                                ...
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                net.bytebuddy.dynamic.DynamicType dynamicType) {
                                                        LOG.info("ByteBuddy transformed (RendererLivingEntity): "
                                                                        + typeDescription.getName());
                                                }
                                                ...
                                                public void onError(String typeName, ClassLoader classLoader,
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                Throwable throwable) {
                                                        LOG.error("ByteBuddy error (RendererLivingEntity) " + typeName
                                                                        + ": " + throwable.getMessage());
                                                }
                                        })
                        ...
                        // This is guaranteed to run ALWAYS and perfectly circumvents LabyMod's
                        // pipeline.
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        .with(net.bytebuddy.agent.builder.AgentBuilder.RedefinitionStrategy.RETRANSFORMATION)
                                        .with(net.bytebuddy.agent.builder.AgentBuilder.InitializationStrategy.NoOp.INSTANCE)
                                        ...
                                        .with(new net.bytebuddy.agent.builder.AgentBuilder.Listener.Adapter() {
                                                ...
                                                public void onTransformation(
                                                                ...
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                net.bytebuddy.dynamic.DynamicType dynamicType) {
                                                        LOG.info("ByteBuddy transformed (EntityRenderer): "
                                                                        + typeDescription.getName());
                                                }
                                                ...
                                                public void onError(String typeName, ClassLoader classLoader,
                                                                net.bytebuddy.utility.JavaModule module, boolean loaded,
                                                                Throwable throwable) {
                                                        LOG.error("ByteBuddy error (EntityRenderer) " + typeName + ": "
                                                                        + throwable.getMessage());
                                                }
                                        })
                                        .type(net.bytebuddy.matcher.ElementMatchers.named("bfk")
                                                        .or(net.bytebuddy.matcher.ElementMatchers.named(
                                                                                        ...
                                                                                        net.bytebuddy.asm.Advice.to(
                                                                                                        ...
                                                                                                        .on(
                                                                                                                        (net.bytebuddy.matcher.ElementMatchers
                                                                                                                                        .named("a")
                                                                                                                                        .or(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .named("updateCameraAndRender")))
                                                                                                                                        .and(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .takesArguments(float.class,
                                                                                                                                                                        long.class)))))
                                        .installOn(instrumentation);

                        // ── Hook PacketDecoder.decode
                        // (net.labymod.core.labyconnect.pipeline.PacketDecoder) ──
                        // Gracefully suppresses the "Packet with id X is not registered" crash which
                        // brings
                        // the whole client down when LabyConnect disconnects with garbage framing bytes
                        // remaining.
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        .with(net.bytebuddy.agent.builder.AgentBuilder.RedefinitionStrategy.RETRANSFORMATION)
                                        .with(net.bytebuddy.agent.builder.AgentBuilder.InitializationStrategy.NoOp.INSTANCE)
                                        ...
                                        .type(net.bytebuddy.matcher.ElementMatchers
                                                        .named("net.labymod.core.labyconnect.pipeline.PacketDecoder"))
                                        .transform((builder, typeDescription, classLoader, module,
                                                        protectionDomain) -> builder
                                                                        .visit(
                                                                                        net.bytebuddy.asm.Advice.to(
                        ...
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        ...
                                        .with(new net.bytebuddy.ByteBuddy()
                                                        .with(net.bytebuddy.dynamic.scaffold.TypeValidation.of(false))
                                                        .with(net.bytebuddy.implementation.attribute.AnnotationRetention.DISABLED))
                                        .type(net.bytebuddy.matcher.ElementMatchers.named("auo")
                                                        .or(net.bytebuddy.matcher.ElementMatchers
                                                                                        ...
                                                                                        net.bytebuddy.asm.Advice.to(
                                                                                                        ...
                                                                                                        .on(
                                                                                                                        (net.bytebuddy.matcher.ElementMatchers
                                                                                                                                        .named("a")
                                                                                                                                        .or(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .named("getObjectiveInDisplaySlot"))
                                                                                                                                        .or(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .named("func_96539_a")))
                                                                                                                                        .and(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .takesArguments(1))
                        ...
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        ...
                                        .with(new net.bytebuddy.ByteBuddy()
                                                        .with(net.bytebuddy.dynamic.scaffold.TypeValidation.of(false))
                                                        .with(net.bytebuddy.implementation.attribute.AnnotationRetention.DISABLED))
                                        .type(net.bytebuddy.matcher.ElementMatchers.named("avp")
                                                        .or(net.bytebuddy.matcher.ElementMatchers
                                                                        .named("net.minecraft.client.gui.Gui")))
                                        .transform((builder, typeDescription, classLoader, module,
                                                        protectionDomain) -> builder
                                                                        .visit(
                                                                                        net.bytebuddy.asm.Advice.to(
                        ...
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        ...
                                        .with(new net.bytebuddy.ByteBuddy()
                                                        .with(net.bytebuddy.dynamic.scaffold.TypeValidation.of(false))
                                                        .with(net.bytebuddy.implementation.attribute.AnnotationRetention.DISABLED))
                                        .type(net.bytebuddy.matcher.ElementMatchers.named("avn")
                                                        .or(net.bytebuddy.matcher.ElementMatchers.named(
                        ...
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        ...
                                        .type(net.bytebuddy.matcher.ElementMatchers.named(
                                                        "net.labymod.core.client.gui.hud.hudwidget.ScoreboardHudWidget"))
                                        .transform((builder, typeDescription, classLoader, module,
                                                        protectionDomain) -> builder
                                                                        .visit(
                                                                                        net.bytebuddy.asm.Advice.to(
                        ...
                        // ── Hook Bootstrap.connect (io.netty.bootstrap.Bootstrap.connect) ──
                        new net.bytebuddy.agent.builder.AgentBuilder.Default()
                                        .with(net.bytebuddy.agent.builder.AgentBuilder.RedefinitionStrategy.RETRANSFORMATION)
                                        .with(net.bytebuddy.agent.builder.AgentBuilder.InitializationStrategy.NoOp.INSTANCE)
                                        .with(net.bytebuddy.agent.builder.AgentBuilder.TypeStrategy.Default.REDEFINE)
                                        .with(new net.bytebuddy.ByteBuddy()
                                                        .with(net.bytebuddy.dynamic.scaffold.TypeValidation.of(false))
                                                        .with(net.bytebuddy.implementation.attribute.AnnotationRetention.DISABLED))
                                        .type(net.bytebuddy.matcher.ElementMatchers.named("io.netty.bootstrap.Bootstrap"))
                                        .transform((builder, typeDescription, classLoader, module,
                                                        protectionDomain) -> builder
                                                                        .visit(
                                                                                        net.bytebuddy.asm.Advice.to(
                                                                                                        com.hades.client.hook.hooks.BootstrapConnectHook.class)
                                                                                                        .on(
                                                                                                                        net.bytebuddy.matcher.ElementMatchers
                                                                                                                                        .named("connect")
                                                                                                                                        .and(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .takesArguments(1))
                                                                                                                                        .and(net.bytebuddy.matcher.ElementMatchers
                                                                                                                                                        .takesArgument(0, java.net.SocketAddress.class)))))
                                        .installOn(instrumentation);
                        LOG.info("ByteBuddy hooked: Bootstrap.connect");
